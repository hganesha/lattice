...
describe('IndustryWorkspaceIcon', () => {
  it.each(['airline', 'core', 'energy', 'financial_services', 'healthcare', 'insurance', 'legal', 'manufacturing', 'real_estate', 'telecommunications'])('renders the %s workspace icon', (domain) => {
